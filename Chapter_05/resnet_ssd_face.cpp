...
int main(int argc, char** argv)
{
    ...
    cout << "Proto: " << modelConfiguration << endl;
    cout << "Binary Weights: " << modelBinary << endl;
    //! [Initialize network]
    ...
    for (;;) {
        ...
        //! [Prepare blob]
        Mat inputBlob = blobFromImage(frame, inScaleFactor, Size(inWidth, inHeight), meanVal, false,
        ...
        for (int i = 0; i < detectionMat.rows; i++) {
            ...
            if (confidence > confidenceThreshold) {
                ...
                putText(frame, label, Point(xLeftBottom, yLeftBottom), FONT_HERSHEY_SIMPLEX, 0.5,
                    Scalar(0, 0, 0));
            }
        }
